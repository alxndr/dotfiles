...
map.n.nore[',d'] = '<CMD>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>'
...
map.n.nore[',g'] = ':Git<CR>'
map.n.nore[',r'] = '<CMD>lua vim.lsp.diagnostic.goto_next()<CR>'
map.n.nore[',R'] = '<CMD>lua vim.lsp.diagnostic.goto_prev()<CR>'
